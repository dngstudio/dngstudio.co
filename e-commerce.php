...
<div class="container-fluid bg-dark">
    <div class="container py-5">
        ...
        <div class="row my-4">
            <div class="col-lg-6 col-sm-12">
                <img src="media\pics\ecom\Product page-01.png" alt="" class="ecom float-lg-end">
            </div>
            <div class="col-lg-6 col-sm-12">
        ...
        <div class="row  my-4">
            <div class="col-lg-6 col-sm-12 text-lg-end order-2 order-sm-1">
        ...
        <div class="row my-4">
            <div class="col-lg-6 col-sm-12">
                <div><img src="media\pics\ecom\Checkout page desktop.png" alt="" class="ecom float-lg-end"></div>
                <div><img src="media\pics\ecom\Checkout page.png" alt="" id="ecom-mobile" class="shadow float-end"></div>  
            </div>
            <div class="col-lg-6 col-sm-12">
