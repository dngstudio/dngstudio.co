        ...
        <div class="text-white" id="marquee"></div>
            ...
            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-5 row-cols-lg-5 bg-dark mt-4 pb-4">
                ...
                <div class="col mt-3">
                    ...
                    <h4 class="text-primary mt-3"><?php echo languagefull; ?></h4>
                    <form name="langSelect" class="lang-switcher" action="" method="get" >
                        <div class="d-flex mt-1">
                        <button class="btn p-0 me-2" name="langID" value="sr_RS">🇷🇸</button>
                        <button class="btn p-0 me-2" name="langID" value="en_US">🇺🇸</button>
                        </div>
                    </form>
                </div>
                <div class="col mt-3">
