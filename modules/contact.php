      ...
      <div class="row">
        ...
        <form action="uspesno-poslato.php" method="POST" id="msform" class="needs-validation" novalidate>
                            ...
                            <fieldset>
                                  ...
                                  <input type="submit" name="next" id="submit-btn" class="next action-button btn btn-outline-secondary g-recaptcha" data-sitekey="6LcFiZUfAAAAAImUZz5ByhbtJPSnIN-0za6kpvwI" data-callback='onSubmit' data-action='submit' value="Pošalji" >&nbsp;</input> 
